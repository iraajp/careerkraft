...
const Signup: React.FC<SignupProps> = ({ onSignupSuccess, onSwitchToLogin }) => {
  ...
  return (
    <div className="w-full max-w-md p-8 bg-gray-800/50 rounded-2xl shadow-2xl backdrop-blur-sm border border-gray-700 animate-fade-in">
      ...
      <p className="text-center text-gray-400 mb-8">Start your career journey with us today.</p>

      {error && <div className="bg-red-800/50 text-red-300 p-3 rounded-lg mb-6 text-center">{error}</div>}

      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label htmlFor="email-signup" className="block text-gray-300 text-sm font-bold mb-2">Email</label>
          <input
            id="email-signup"
            type="email"
            value={email}
        ...
        <div className="mb-6">
          <label htmlFor="password-signup" className="block text-gray-300 text-sm font-bold mb-2">Password</label>
          <input
            id="password-signup"
            type="password"
            value={password}
        ...
        <p className="text-center text-gray-400">
          ...
          <button type="button" onClick={onSwitchToLogin} className="font-semibold text-purple-400 hover:text-purple-300">
            Login
          </button>
        </p>
      </form>
